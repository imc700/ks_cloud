...
public class AuthService {
    ...
    private AuthToken applyToken(String username, String password, String clientId, String clientSecret) {
        ...
        if (bodyMap == null ||
            ...
            if (StringUtils.isNotEmpty(error_description)) {
                if (error_description.contains("坏的凭证")) ExceptionCast.cast(AuthCode.AUTH_CREDENTIAL_ERROR);
                if (error_description.contains("returned null")) ExceptionCast.cast(AuthCode.AUTH_ACCOUNT_NOTEXISTS);
            }
            ExceptionCast.cast(AuthCode.AUTH_LOGIN_APPLYTOKEN_FAIL);
        }
    ...
    public boolean delToken(String access_token){
        String name = "user_token:" + access_token; stringRedisTemplate.delete(name);
        return true;
    }
